...
int QSPI_Init(void){
  ...
  esp_lcd_panel_io_spi_config_t io_config ={
    ...
    .flags = {
      .dc_low_on_data = 0,
      .octal_mode = 0,
      // .quad_mode = 1,     // Removed in newer ESP-IDF versions
      // .sio_mode = 0,      // Removed in newer ESP-IDF versions
      .lsb_first = 0,
      // .cs_high_active = 0, // Removed in newer ESP-IDF versions
    },                                  
  };
  ...
  esp_lcd_panel_dev_config_t panel_config={
    ...
    // .rgb_ele_order = LCD_RGB_ELEMENT_ORDER_RGB,  // Removed in newer ESP-IDF
    // .data_endian = LCD_RGB_DATA_ENDIAN_BIG,      // Removed in newer ESP-IDF
