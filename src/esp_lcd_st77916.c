...
esp_err_t esp_lcd_new_panel_st77916(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel)
{
    ...
    // RGB element order - using default RGB order
    // The rgb_ele_order field has been removed from newer ESP-IDF versions
    st77916->madctl_val = 0;  // Default to RGB order
    ...
    // disp_on_off has been replaced with disp_off in newer ESP-IDF
